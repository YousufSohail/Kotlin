...
# More concise: Rough estimates indicate approximately a 40% cut in the number of lines of code.
...
//TODO: Who is using Kotlin?

According to Jetbrains blog, Kotlin is used by Amazon Web Services, Pinterest, Coursera, Netflix, Uber, Square, Trello, Basecamp, Flipboard, Pinterest and 69 others.




//TODO: From where to Learn

Official site:          https://kotlinlang.org
Developer dot Android:  https://developer.android.com/kotlin/index.html
Google I/O video:       https://www.youtube.com/watch?v=fPzxfeDJDzY
Online IDE:             https://try.kotlinlang.org/
and in Android Studio:  Copy/paste Java code to Kotlin file to convert
